...
import com.uryadov.productservice.repository.ProductRepository;
import com.uryadov.productservice.util.EntityDtoUtil;
...
public class ProductService {
    ...
    public Flux<ProductDto> getInPriceRange(Integer min, Integer max) {
